...
export const getAllUsers = async (req, res) => {
  try {
    ...
    const { role = "user", status, plan_id: planId, plan_slug: planSlug } = req.query;
...
export const createUser = async (req, res) => {
  try {
    const { name, email, password, phone, country, country_code: countryCode, note, role = 'user' } = req.body;
